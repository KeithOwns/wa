...
& {
    ...
    $Esc = [char]0x1B; $Reset = "$Esc[0m"; $Bold = "$Esc[1m"; $FGGreen = "$Esc[92m"; $FGRed = "$Esc[91m"; $FGCyan = "$Esc[96m"; $FGDarkBlue = "$Esc[34m"; $FGGray = "$Esc[37m"
    ...
    try {
        ...
        if ($current -ne $target) {
            ...
            Write-LeftAligned "$FGGreen[v] 'Notify Restart' set to $msg.$Reset"
        }
        else { Write-LeftAligned "$FGGray[-] 'Notify Restart' is already set to target.$Reset" }
    }
