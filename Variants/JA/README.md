...
JA is the core, standalone delivery of the full [WinAuto](https://github.com/KeithOwns/winauto) suite. It is a powerful, lightweight automation script designed to streamline configuration, security hardening, and maintenance of Windows 11 systems — organized into standalone atomic components.
...
Unlike the full WinAuto suite, the JA repository relies on a modular, atomic architecture:

-   `ja.ps1`: The complete standalone core script comprising the interactive dashboard and all automation logic. No external dependencies or separate folders required.
