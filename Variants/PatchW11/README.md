# PatchW11 (Core Version of WinAuto)
...
PatchW11 is the core, standalone delivery of the full [WinAuto](https://github.com/KeithOwns/winauto) suite. It is a powerful, lightweight automation script designed to streamline configuration, security hardening, and maintenance of Windows 11 systems—consolidated entirely into one interactive file.
...
Unlike the full WinAuto suite, the PatchW11 repository relies on a strictly single-file architecture:

-   `PatchW11.ps1`: The complete standalone core script comprising the interactive dashboard and all automation logic. No external dependencies or separate folders required.
