...
$Global:TickAction = {
    ...
    if ($ActionText -eq "DASHBOARD") {
        ...
        $Line = "                        ${Global:FGYellow}Cursor${Global:FGBlack}${Global:BGDarkCyan}KEYS${Global:Reset}                       `n   ${Global:FGBlack}${Global:BGDarkCyan} ^ ${Global:Reset}  ${Global:FGGray}arrow${Global:Reset}  ${Global:FGBlack}${Global:BGDarkCyan} v ${Global:Reset}  ${Global:FGGray}keys${Global:Reset} ${Global:FGYellow}->${Global:Reset}${Global:FGDarkGray}|${Global:Reset}${Global:FGWhite}Select${Global:Reset}${Global:FGDarkGray}|${Global:Reset}${Global:FGYellow}<-${Global:Reset} ${Global:FGDarkGray}|${Global:Reset} ${Global:FGBlack}${Global:BGDarkCyan}Esc${Global:Reset} ${Global:FGGray}to${Global:Reset} ${Global:FGDarkRed}${Global:BGWhite}EXIT${Global:Reset}"
    }
...
while ($true) {
    ...
    if ($MenuSelection -eq 0) {
        Write-Centered "${FGYellow}->${Global:Reset}${FGCyan}${BGYellow}|${Reset}${FGBlack}${BGYellow}SmartRUN${Reset}${FGCyan}${BGYellow}|${Reset}${Global:Reset}${FGYellow}<-${Reset}"
    }
    else {
        Write-Centered "${FGCyan}Smart${FGBlack}${BGYellow}R${Reset}${FGCyan}UN${Reset}"
    }
    ...
    Write-Centered "${FGYellow}Hot${FGBlack}${BGYellow}KEYS${Reset} "
    Write-Centered "${FGBlack}${BGYellow}I${Reset}${FGGray}nstall${Reset} ${FGDarkGray}|${Reset} ${FGBlack}${BGYellow}C${Reset}${FGGray}onfigure${Reset} ${FGDarkGray}|${Reset} ${FGBlack}${BGYellow}M${Reset}${FGGray}aintain${Reset} ${FGDarkGray}|${Reset} ${FGBlack}${BGYellow}H${Reset}${FGGray}elp${Reset} "
    Write-Host ""
    Write-Host ""
    ...
    if ($MenuSelection -eq 1) {
        Write-LeftAligned "${FGYellow}->${Reset}${FGBlack}${BGDarkCyan}|${Reset}${FGBlack}${BGDarkCyan}I${Reset}${FGBlack}${BGDarkCyan}nstall Applications${Reset}${FGBlack}${BGDarkCyan}|${Reset}${FGYellow}<-${Reset}" -Indent 17
    }
    else {
    ...
    if ($MenuSelection -eq 2) {
        Write-LeftAligned "${FGYellow}->${Reset}${FGBlack}${BGDarkCyan}|${Reset}${FGBlack}${BGDarkCyan}C${Reset}${FGBlack}${BGDarkCyan}onfigure Operating System${Reset}${FGBlack}${BGDarkCyan}|${Reset}${FGYellow}<-${Reset}" -Indent 14
    }
    else {
    ...
    if ($MenuSelection -eq 3) {
        Write-LeftAligned "${FGYellow}->${Reset}${FGBlack}${BGDarkCyan}|${Reset}${FGBlack}${BGDarkCyan}M${Reset}${FGBlack}${BGDarkCyan}aintain Operating System${Reset}${FGBlack}${BGDarkCyan}|${Reset}${FGYellow}<-${Reset}" -Indent 14
    }
    else {
    ...
    # Hotkey Logic (R, I, C, M) - Maps to Selection + Space
    if ($res.Character -eq 'R' -or $res.Character -eq 'r') { $MenuSelection = 0; $res.Character = ' ' }
