...
function Write-Footer {
    ...
    Write-Centered "NAVIGATION KEYS" -Width 52 -Color $Global:FGDarkYellow
    Add-DashLine "  ${Global:FGDarkYellow}Press ${Global:FGBlack}${Global:BGCyan}Enter${Global:Reset}${Global:FGDarkYellow} to Run        | Press ${Global:FGWhite}Space${Global:Reset}${Global:FGDarkYellow} to Toggle${Global:Reset}"
    Add-DashLine "  ${Global:FGDarkYellow}Use arrow  ${Global:FGWhite}^${Global:Reset}${Global:FGDarkYellow} ${Global:FGWhite}v${Global:Reset}${Global:FGDarkYellow}  to select | Press  ${Global:FGBlack}${Global:BGCyan}Esc${Global:Reset}${Global:FGDarkYellow} to ${Global:FGWhite}EXIT${Global:Reset}${Global:FGDarkYellow} =>${Global:Reset}"
}
