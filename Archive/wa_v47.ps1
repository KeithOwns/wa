...
function Write-Footer {
    ...
    if ($Global:MenuSelection -eq 0) {
        $enterText = "${Global:FGDarkYellow}Press ${Global:FGBlack}${Global:BGDarkYellow}Enter${Global:Reset}${Global:FGDarkYellow} to ${Global:FGBlack}${Global:BGYellow}|SmartRun|${Global:Reset} "
...
while ($true) {
    ...
    if ($Global:MenuSelection -eq 0) {
        ...
        Add-DashLine "  $(' ' * 18)${FGYellow}>${Reset}${FGBlack}${BGYellow}| SmartRun |${Reset}$(' ' * 21)"
    }
    else {
