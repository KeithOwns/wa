...
function Write-Footer {
    ...
    Add-DashLine "  Use arrows ${Global:FGWhite}^  v${Global:Reset}${Global:FGGray} to select | Press  ${Global:FGBlack}${Global:BGCyan}Esc${Global:Reset}${Global:FGGray} to EXIT =>${Global:Reset}"
}
