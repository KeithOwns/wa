...
function Write-Log {
    ...
    if ($Message -eq "CLI Execution Complete." -or $Message -eq "Interactive Execution Complete.") {
        ...
        Write-Host "____________________________________________________" -ForegroundColor DarkYellow
...
function Write-Footer {
    $enterText = ""
    $suffixText = "| Press ${Global:FGBlack}${Global:BGDarkYellow}Spacebar${Global:Reset}${Global:FGDarkYellow} to Toggle"

    if ($Global:MenuSelection -eq 0) {
        $enterText = "Press ${Global:FGBlack}${Global:BGDarkYellow}Enter${Global:Reset}${Global:FGDarkYellow} to ${Global:FGBlack}${Global:BGYellow}|SmartRun|${Global:Reset} "
    } elseif ($Global:MenuSelection -eq 1) {
        $enterText = "Press ${Global:FGBlack}${Global:BGDarkYellow}Enter${Global:Reset}${Global:FGDarkYellow} for ${Global:FGBlack}${Global:BGYellow}|ManualMode|${Global:Reset}"
        $suffixText = "  Press ${Global:FGBlack}${Global:BGDarkYellow}Space${Global:Reset}${Global:FGDarkYellow} to Toggle "
    } else {
        $enterText = "Press ${Global:FGBlack}${Global:BGDarkYellow}Enter${Global:Reset}${Global:FGDarkYellow} to Run        "
    }
    ...
    Write-Centered "${Global:FGDarkYellow}NAVIGATION ${Global:FGBlack}${Global:BGYellow}Keys${Global:Reset}" -Width 52
}
...
while ($true) {
    ...
    if ($Global:MenuSelection -eq 0) {
        ...
        Add-DashLine "  $(' ' * 19)${FGBlack}${BGYellow}| SmartRun |${Reset}$(' ' * 21)"
    }
    else {
