...
function Write-Footer {
    ...
    Add-DashLine "  ${Global:FGDarkYellow}Press ${Global:FGBlack}${Global:BGDarkYellow}Enter${Global:Reset}${Global:FGDarkYellow} to Run        | Press ${Global:FGBlack}${Global:BGDarkYellow}Spacebar${Global:Reset}${Global:FGDarkYellow} to Toggle${Global:Reset}"
    Add-DashLine "  ${Global:FGDarkYellow}Use arrow  ${Global:FGBlack}${Global:BGDarkYellow}^${Global:Reset}${Global:FGDarkYellow} ${Global:FGBlack}${Global:BGDarkYellow}v${Global:Reset}${Global:FGDarkYellow}  to select | Press  ${Global:FGBlack}${Global:BGDarkYellow}Esc${Global:Reset}${Global:FGDarkYellow} to ${Global:FGWhite}<EXIT>${Global:Reset}"
}
